...
const allProducts = [
  ...
  { id: '3', image: bodyLotionSandalwood, name: 'Sandalwood Body Lotion', category: 'Body Care', desc: 'A deeply nourishing body lotion with pure Sandalwood and Ayurvedic herbs. Leaves skin soft, smooth and beautifully scented.', price: 2200, volume: '200ml', ingredients: ['Sandalwood', 'Coconut Oil', 'Ayurvedic Herbs'] },
  ...
  { id: '7', image: hairOil, name: 'Ayurvedic Hair Oil', category: 'Hair Care', desc: 'Traditional ayurvedic hair oil that strengthens roots, reduces hair fall and adds natural shine. Made with pure Ceylon herbs.', price: 1000, volume: '100ml', ingredients: ['Coconut Oil', 'Hibiscus', 'Kalanduru'] },
  { id: '8', image: nightCream, name: 'Ayurvedic Night Cream', category: 'Face Care', desc: 'A rich night cream infused with Ayurvedic herbs that restores, rejuvenates and deeply nourishes your skin overnight.', price: 2500, volume: '50ml', ingredients: ['Saffron', 'Sandalwood', 'Gotukola'] },
];
